...
class UserForm(forms.ModelForm):
    ...
    # esse formulário foi feito para criar e para atualizar, ideal seria fazer um específico para cada

    password = forms.CharField(
        required=False,
        widget=forms.PasswordInput(),
        label='Senha'  # para exibir como Senha
        # help_text='texto de ajuda, estilo placeholder'
    )
    ...
    def clean(self, *args, **kwargs):
        ...
        # usuarios não logados: cadastro
            ...
            if email_db:  # os _db traz a consulta inteira, precisa dizer qual campo
                validation_error_msgs['email'] = error_msg_email_exists
